...
def parse_profile(i):
    mem_profiler_file = f'{home_path}/mlp_profiler_result/orin/{i}_mem.txt'
    cpu_profiler_file = f'{home_path}/mlp_profiler_result/orin/{i}_cpu.txt'
...
df.to_csv('cpu_mem_orin.csv', index=False)